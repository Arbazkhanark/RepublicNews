        ...
        <AdminLayout>
            ...
            <Card>
                ...
                <div className="space-y-4">
                    ...
                    <div key={item} className="flex items-center space-x-4">
                        ...
                        <h4 className="text-sm font-medium">Sample News Article {item}</h4>
            ...
            <Card>
                ...
                <div className="space-y-2">
                    ...
                    <div className="text-sm text-gray-500">Start writing a new news article</div>
                    </button>
                    <button className="w-full text-left p-3 rounded-lg border hover:bg-gray-50">
                    <div className="font-medium">Review Drafts</div>
                    <div className="text-sm text-gray-500">Check pending draft articles</div>
                    </button>
                    <button className="w-full text-left p-3 rounded-lg border hover:bg-gray-50">
                    <div className="font-medium">Manage Categories</div>
                    <div className="text-sm text-gray-500">Organize article categories</div>
                    </button>
                </div>
                </CardContent>
            </Card>
