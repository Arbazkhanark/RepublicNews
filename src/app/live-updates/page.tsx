...
//             title: `Live Update: ${["Market", "Political", "Weather", "Sports"][Math.floor(Math.random() * 4)]} Development`,
//             content:
...
//             timestamp: new Date(),
//             priority: ["breaking", "urgent", "normal"][Math.floor(Math.random() * 3)] as
//               | "breaking"
//               | "urgent"
//               | "normal",
//             category: ["Politics", "Economy", "Sports", "Technology"][Math.floor(Math.random() * 4)],
//             author: "Live Desk",
//             tags: ["live", "update"],
//           }
...
//                 Live Updates
//               </h1>
//               <p className="text-xl text-red-100">Real-time news and breaking updates</p>
//             </div>
...
//                 </button>
//               </div>
//               <p className="text-sm text-red-200">Last updated: {formatTimeAgo(lastUpdate)}</p>
//             </div>
//           </div>
//         </div>
//       </div>
...
//             {updates.filter((update) => update.priority === "breaking").length > 0 && (
...
//                 </div>
//                 <h2 className="text-xl font-bold">{updates.find((update) => update.priority === "breaking")?.title}</h2>
//               </div>
//             )}
...
//                         <span
//                           className={`px-3 py-1 rounded-full text-xs font-bold ${getPriorityColor(update.priority)}`}
//                         >
//                           {getPriorityIcon(update.priority)} {update.priority.toUpperCase()}
//                         </span>
//                         <span className="bg-gray-100 text-gray-700 px-2 py-1 rounded text-xs font-medium">
//                           {update.category}
//                         </span>
//                         {update.location && (
//                           <span className="text-gray-500 text-xs flex items-center gap-1">📍 {update.location}</span>
//                         )}
//                       </div>
//                       <div className="text-right text-sm text-gray-500">
//                         <div>{formatTimeAgo(update.timestamp)}</div>
//                         <div className="text-xs">{update.timestamp.toLocaleTimeString()}</div>
//                       </div>
//                     </div>
...
//             {/* Ad Space */}
//             <div className="mb-8">
//               <GoogleAdsense adSlot="live-updates-sidebar-ad" adFormat="rectangle" className="w-full" />
//             </div>

//             {/* Live Stats */}
//             <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
//               <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">📊 Live Statistics</h3>
//               <div className="space-y-4">
//                 <div className="flex justify-between items-center">
//                   <span className="text-gray-600">Updates Today</span>
//                   <span className="font-bold text-gray-900">{updates.length}</span>
//                 </div>
//                 <div className="flex justify-between items-center">
...
//                 {["Parliament Session", "Stock Market Rally", "Weather Alert", "Cricket Victory", "ISRO Launch"].map(
//                   (topic, index) => (
...
//                       </div>
//                       <span className="text-sm text-gray-500">{Math.floor(Math.random() * 50) + 10}k</span>
//                     </div>
//                   ),
//                 )}
//               </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-80">
            {/* Ad Space */}
            <div className="mb-8">
              <GoogleAdSense adSlot="live-updates-sidebar-ad" adFormat="rectangle" className="w-full" /> {/* ✅ Fixed component name */}
            </div>
