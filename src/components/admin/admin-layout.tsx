...
import { Home, FileText, Plus, Users, Settings, LogOut, Menu, Bell, Search } from "lucide-react"
...
// }, [])
  ...
  const menuItems = [
    ...
    { href: "/admin/newsletter", icon: FileText, label: "Newsletter" , adminOnly: true},
    { href: "/admin/categories", icon: FileText, label: "Categories", adminOnly: true },
    { href: "/admin/opinions", icon: FileText, label: "Opinions", adminOnly: true },
            ...
            <div className="flex items-center justify-between px-6 py-4">
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-xl font-semibold text-gray-900">
                  ...
                  {pathname.startsWith("/admin/articles/") && pathname.endsWith("/edit") && "Edit Article"}
