...
export function RichTextEditor({ content, onChange, placeholder }: RichTextEditorProps) {
  ...
  const formatButtons = [
    { icon: Heading1, action: () => insertFormatting("# "), label: "Heading 1" },
    { icon: Heading2, action: () => insertFormatting("## "), label: "Heading 2" },
    { icon: Heading3, action: () => insertFormatting("### "), label: "Heading 3" },
    ...
    { icon: ListOrdered, action: () => insertFormatting("1. "), label: "Numbered List" },
