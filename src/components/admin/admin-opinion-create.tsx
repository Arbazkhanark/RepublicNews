...
//       console.log('Creating opinion:', requestBody);
...
//       toast.success(`Opinion ${status === 'draft' ? 'saved as draft' : 'submitted for approval'} successfully`);
...
//                     onValueChange={(value: 'draft' | 'pending') => handleInputChange('status', value)}
//                     disabled={saving}
//                   >
...
//                 <Button variant="outline" className="w-full transition-smooth" disabled={saving}>
...
//                     disabled={saving}
//                   />
//                   <Button onClick={addTag} variant="outline" size="sm" disabled={saving}>
...
//                 <p>• Ensure your content is original and respectful</p>
//                 <p>• Use appropriate tags for better categorization</p>
//                 <p>• Drafts are saved privately</p>
//                 <p>• Submitted articles require admin approval</p>
//                 <p>• Include relevant images when possible</p>
//               </CardContent>
//             </Card>
//           </div>
//         </div>
...
//             <Button 
//               onClick={() => handleSave('pending')}
//               className="flex-1 bg-brand-primary hover:bg-brand-dark transition-smooth"
//               disabled={saving}
//             >
//               {saving ? (
//                 <Loader2 className="w-4 h-4 mr-1 animate-spin" />
...
// app/admin/opinions/new/page.tsx
'use client';
