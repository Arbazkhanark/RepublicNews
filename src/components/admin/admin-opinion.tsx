...
//       if (!response.ok) {
//         throw new Error(`Failed to ${editModalOpen ? 'update' : 'create'} opinion`);
//       }
...
//               <span>{editModalOpen ? 'Edit Opinion' : 'Create New Opinion'}</span>
...
//                 )}
//                 {formLoading ? 'Saving...' : (editModalOpen ? 'Update' : 'Create')}
//               </Button>
...
//           <Button onClick={()=>''}>Create new opinion</Button>
//         </div>
        ...
        <div className="space-y-4">
          {filteredOpinions.length === 0 ? (
            <Card>
              <CardContent className="p-8 text-center">
                <FileText className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
                <h3 className="text-lg font-semibold mb-2">No opinions found</h3>
                <p className="text-muted-foreground">
                  {filter === 'all' 
                    ? "No opinions have been created yet." 
                    : `No ${filter} opinions found.`}
            ...
            filteredOpinions.map((opinion) => (
              <Card key={opinion._id} className="hover:shadow-md transition-shadow">
                <CardContent className="p-6">
                  <div className="flex flex-col lg:flex-row gap-4">
                    {opinion.imageUrl && (
                      <img 
