...
import { Users, UserPlus, MoreHorizontal, Edit, Trash2, Shield, Activity, Crown, PenTool } from "lucide-react"
...
export default function UsersPage() {
  ...
  const getRoleColor = (role: User["role"]): "destructive" | "default" | "secondary" | "outline" => {
    switch (role) {
      case "admin":
        return "destructive"
      case "editor":
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Add a new user to your news website.</DialogDescription>
            </DialogHeader>
        ...
        {userStats.map((stat, index) => (
          <Card key={index}>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">{stat.change !== "0" && `${stat.change} from last month`}</p>
            </CardContent>
          </Card>
        ))}
      </div>
