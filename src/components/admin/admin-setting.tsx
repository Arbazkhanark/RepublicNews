    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Configure your news website settings and preferences</p>
        </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => handleSettingChange("adsenseEnabled", checked)}
                />
                ...
                <>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleSettingChange("adsenseClientId", e.target.value)}
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => handleSettingChange("headerAdCode", e.target.value)}
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => handleSettingChange("sidebarAdCode", e.target.value)}
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => handleSettingChange("articleAdCode", e.target.value)}
