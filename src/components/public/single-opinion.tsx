...
// import { ArrowLeft, Heart, MessageCircle, Share, Clock, User, ThumbsUp, ThumbsDown, Send } from 'lucide-react';
...
//       // API call
//       await fetch(`/api/public/opinion/${opinion._id}/like`, {
//         method: 'POST',
//         headers: {
...
//       // API call
//       await fetch(`/api/public/opinion/${opinion._id}/dislike`, {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//         },
...
//       await fetch(`/api/public/opinion/comments/${commentId}/like`, {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//         },
...
//                     <AvatarImage src={opinion.authorId.profileImage} />
//                     <AvatarFallback>
...
//                             comment.likedBy.includes(localStorage.getItem('user-id') || '')
//                               ? 'text-green-600'
//                               : 'text-muted-foreground hover:text-green-600'
//                           } transition-colors`}
//                         >
...
// import { useState, useEffect } from 'react';
// import { useParams, useRouter } from 'next/navigation';
// import { ArrowLeft, Heart, MessageCircle, Share, Clock, User, ThumbsUp, ThumbsDown, Send, Edit, Trash2 } from 'lucide-react';
// import { Button } from '@/components/ui/button';
// import { Card, CardContent } from '@/components/ui/card';
// import { Badge } from '@/components/ui/badge';
// import { Textarea } from '@/components/ui/textarea';
...
//       const data = await response.json();
//       setOpinion(data.opinion);
//       toast.success(newInteraction === 'disliked' ? 'Disliked!' : 'Dislike removed');
...
//   const isAuthor = opinion && currentUser && 
...
//                     ? 'text-green-600' 
//                     : 'text-muted-foreground hover:text-green-600'
//                 } transition-colors ${!currentUser ? 'opacity-50 cursor-not-allowed' : ''}`}
...
import { useParams, useRouter } from 'next/navigation';
import { ArrowLeft, MessageCircle, Share, Clock, ThumbsUp, ThumbsDown, Send, Edit, Trash2 } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Card, CardContent } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { Textarea } from '@/components/ui/textarea';
