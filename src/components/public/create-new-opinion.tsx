...
export default function NewOpinionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Opinion submitted successfully! It will be published after admin approval.');
                ...
                <CardContent className="space-y-4">
                  <div className="flex gap-2">
                    <Input
                      ...
                      disabled={loading}
                    />
                    <Button onClick={addTag} variant="outline" size="sm" disabled={loading}>
